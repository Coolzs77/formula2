...
def train_model(epochs=15, batch_size=64, learning_rate=0.001):
    ...
    final_model_path = os.path.join('../model', 'symbol_model.pth')
    ...
    for epoch in range(epochs):
        ...
        with torch.no_grad():
            ...
            for data, target in progress_bar:
                ...
                # 更新进度条
                progress_bar.set_postfix(loss=loss.item(), acc=test_correct/test_total)
    ...
    # 绘制训练曲线
    plot_training_history(history, save_path=os.path.join('../model', 'training_history.png'))
